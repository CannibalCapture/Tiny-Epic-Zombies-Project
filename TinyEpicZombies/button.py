...
class AttackButton(Button):
    ...
    def updateImg(self):
        ...
        if self.enabled:
            self.img = pygame.image.load(os.path.join("TinyEpicZombies", "assets", "attackTrue.png"))
        else:
            self.img = pygame.image.load(os.path.join("TinyEpicZombies", "assets", "attackFalse.png"))
...
class MoveButton(Button):
    ...
    def updateImg(self):
        width, height = 0.05, 0.08 # maybe put in json file
        if self.enabled:
            self.img = pygame.image.load(os.path.join("TinyEpicZombies", "assets", "healthTrue.png"))
        else:
            self.img = pygame.image.load(os.path.join("TinyEpicZombies", "assets", "healthFalse.png"))
